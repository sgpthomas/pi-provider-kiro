...
pi extension that connects the pi coding agent to the Kiro API (AWS CodeWhisperer/Q). Provides 21 models across 8 families with multi-provider authentication (AWS Builder ID, Google, GitHub).
