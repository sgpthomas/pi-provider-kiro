...
- Add Claude Fable 5.1 (`claude-fable-5.1`, exposed to Pi as `claude-fable-5-1`) and retain the currently available Opus 5 and GPT 5.6 variants as startup bootstrap models. Their capabilities were verified against the authenticated Kiro management catalog; catalog metadata remains authoritative after discovery.
